...
object Host : Parameter<String> {
    override fun getPath(): String = "general.database.host"
    override fun getDescription(): List<String> = listOf("The database host.", "Only for MySQL.")
    override fun getDefault(): StringValue = StringValue("127.0.0.1")
