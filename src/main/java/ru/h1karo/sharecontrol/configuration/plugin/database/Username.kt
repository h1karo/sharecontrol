...
object Username : Parameter<String> {
    override fun getPath(): String = "general.database.username"
    override fun getDescription(): List<String> = listOf(
        "The username to access the database.",
        "This user MUST have ALL rights to the specified database.",
        "Only for MySQL."
    )
    override fun getDefault(): StringValue = StringValue("root")
